  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="bg-white/10 p-6 rounded-xl w-full max-w-md text-center">
        ...
        <select value={mood} onChange={(e) => setMood(e.target.value)} className="w-full p-2 mb-4 bg-purple-800 text-white rounded-lg">
        ...
        <button onClick={handleCheckin} className="bg-cyan-500 hover:bg-cyan-600 text-white py-2 px-4 rounded-full">Registrar</button>
      </div>
    </div>
  );
};
